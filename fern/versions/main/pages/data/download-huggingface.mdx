...
**Prerequisites**: NeMo Gym installed ([Detailed Setup](/main/get-started/detailed-setup))
...
<Card title="Collect Rollouts" href="/main/get-started/rollout-collection">

Generate training examples by running your agent on prepared data.
</Card>

<Card title="Train with NeMo RL" href="/main/training-tutorials/nemo-rl-grpo">
