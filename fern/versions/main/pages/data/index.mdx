...
- **NeMo Gym installed**: See [Detailed Setup](/main/get-started/detailed-setup)
...
<Card title="Prepare and Validate" href="/main/data/prepare-validate">
Full data preparation workflow.

<Badge minimal outlined>data-prep</Badge>
</Card>

<Card title="Download from Hugging Face" href="/main/data/download-huggingface">
Fetch datasets from HuggingFace Hub.

<Badge minimal outlined>huggingface</Badge>
</Card>

<Card title="Prompt Config" href="/main/data/prompt-config">
...
See [Cli Commands](/main/reference/cli-commands) for details.
