...
Before starting, complete the [NeMo RL GRPO tutorial](/main/training-tutorials/nemo-rl-grpo) to understand the NeMo RL training workflow and GRPO fundamentals.
