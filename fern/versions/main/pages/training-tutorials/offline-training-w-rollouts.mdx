...
- Completed [Detailed Setup](/main/get-started/detailed-setup)
- Collected rollouts ([Rollout Collection](/main/get-started/rollout-collection))
...
<Card title="GRPO Training" href="/main/training-tutorials/nemo-rl-grpo">
