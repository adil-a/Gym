...
<NavButton href="/main/training-tutorials/nemo-rl-grpo" label="Back to Tutorial Overview" direction="back" />
...
<NavButton href="/main/training-tutorials/nemo-rl-grpo/gym-configuration" label="Continue to Gym Configuration" direction="next" />
