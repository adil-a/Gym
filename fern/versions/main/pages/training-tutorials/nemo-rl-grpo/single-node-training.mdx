...
<NavButton href="/main/training-tutorials/nemo-rl-grpo/setup" label="Previous: Setup" direction="prev" />
...
- ✅ Completed the [Setup](/main/training-tutorials/nemo-rl-grpo/setup) instructions
...
<NavButton href="/main/training-tutorials/nemo-rl-grpo/multi-node-training" label="Continue to Multi-Node Training" direction="next" />
