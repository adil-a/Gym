...
<Card title="vLLM" href="/main/model-server/vllm">
...
<Note>
[Model Server Fields](/main/reference/configuration#model-server-fields) for server configuration syntax and fields.
