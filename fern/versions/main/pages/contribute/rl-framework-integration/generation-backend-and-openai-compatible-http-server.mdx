...
| vLLM | [OpenAI-Compatible Server](https://docs.vllm.ai/en/main/serving/openai_compatible_server/) |
...
- [On-Policy Corrections](/main/contribute/rl-framework-integration/openai-compatible-http-server-on-policy-correction) - Required fixes for multi-step and multi-turn scenarios
- [Gym Integration Footprint And Form Factor](/main/contribute/rl-framework-integration/gym-integration-footprint-and-form-factor) - Full integration component breakdown
