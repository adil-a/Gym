...
<Tip>
Just want to train models? See [Training Tutorials](/main/training-tutorials) for supported frameworks.
...
<Card title="Generation Backend" href="/main/contribute/rl-framework-integration/generation-backend-and-openai-compatible-http-server">
...
<Card title="On-Policy Corrections" href="/main/contribute/rl-framework-integration/openai-compatible-http-server-on-policy-correction">
...
<Card title="Integration Footprint" href="/main/contribute/rl-framework-integration/gym-integration-footprint-and-form-factor">
...
<Card title="Success Criteria" href="/main/contribute/rl-framework-integration/gym-rl-framework-integration-success-criteria">
