...
<Note>
[Configuration](/main/about/concepts/configuration) for understanding how configs are structured and how servers connect.
...
<Note>
[Configuration](/main/troubleshooting/configuration) for common configuration errors and solutions.
