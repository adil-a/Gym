...
<Card title="Configuration" href="/main/reference/configuration">
YAML configuration schema and options for servers, agents, and datasets.
</Card>

<Card title="RL Framework Compatibility" href="/main/reference/rl-framework-compatibility">
Compatibility matrix for NeMo RL, TRL, Unsloth, and other training frameworks.
</Card>

<Card title="CLI Commands" href="/main/reference/cli-commands">
All CLI commands, arguments, and usage examples.
</Card>

<Card title="FAQ" href="/main/reference/faq">
