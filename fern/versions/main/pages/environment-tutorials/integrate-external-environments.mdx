...
4. You can run the `ng_test` command to run tests on your agent server. Refer to the [ng_test CLI reference](https://docs.nvidia.com/nemo/gym/main/reference/cli-commands.html#ng-test-nemo-gym-test) for details.   
