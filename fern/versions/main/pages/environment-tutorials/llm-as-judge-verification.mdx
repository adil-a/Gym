...
- [task-verification](/main/about/concepts/task-verification) — especially *What is LLM-as-a-judge?*
- [core-components](/main/about/concepts/core-components) — resources server vs. model server roles
- [configuration-concepts](/main/about/concepts/configuration) — Hydra composition and server references
...
For how NeMo Gym sits next to GPUs and training frameworks, see [Deployment Topology](/main/infrastructure/deployment-topology).
...
- [task-verification](/main/about/concepts/task-verification) — verification patterns and reward design
- [Index](/main/resources-server) — role of `verify()`
