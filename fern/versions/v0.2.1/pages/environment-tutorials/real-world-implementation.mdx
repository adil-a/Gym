...
description: ""
---
This page covers the **Resources Server** implementation for the [Workplace Assistant](/v0.2.1/environment-tutorials/real-world-environment) environment. The full workflow — task data preparation, agent/model configuration, rollout collection, and training — follows the same steps as the [single-step tutorial](/v0.2.1/environment-tutorials/single-step-environment). What changes here is the scale and complexity of the Resources Server.

[< Previous: Generating Training Data](/v0.2.1/environment-tutorials/real-world-data-generation)
...
<Tip>
For a deeper dive into verification strategies, reward shaping, and common pitfalls, see [task-verification](/v0.2.1/about/concepts/task-verification).

</Tip>

---

[< Back to Workplace Assistant](/v0.2.1/environment-tutorials/real-world-environment)
