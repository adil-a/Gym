...
description: ""
---
Generate synthetic task data (user queries) for the [Workplace Assistant](/v0.2.1/environment-tutorials/real-world-environment) environment using [NeMo Data Designer](https://github.com/NVIDIA-NeMo/DataDesigner). 
...
After generating your task data, use it with the Workplace Assistant resources server to [collect rollouts](/v0.2.1/get-started/rollout-collection) (where the environment produces model responses) and then proceed to [GRPO training](/v0.2.1/training-tutorials/nemo-rl-grpo).

[Next: Resources Server Implementation >](/v0.2.1/environment-tutorials/real-world-implementation)
