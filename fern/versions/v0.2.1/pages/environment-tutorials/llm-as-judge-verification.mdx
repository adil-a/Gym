...
- [task-verification](/v0.2.1/about/concepts/task-verification) — especially *What is LLM-as-a-judge?*
- [core-components](/v0.2.1/about/concepts/core-components) — resources server vs. model server roles
- [configuration-concepts](/v0.2.1/about/concepts/configuration) — Hydra composition and server references
...
For how NeMo Gym sits next to GPUs and training frameworks, see [Deployment Topology](/v0.2.1/infrastructure/deployment-topology).
...
- [task-verification](/v0.2.1/about/concepts/task-verification) — verification patterns and reward design
- [Index](/v0.2.1/resources-server) — role of `verify()`
- [Deployment Topology](/v0.2.1/infrastructure/deployment-topology) — cluster layout and GPUs
- [New Environment](/v0.2.1/contribute/environments/new-environment) — scaffolding a new resources server
