...
<Note>
[Configuration](/v0.2.1/about/concepts/configuration) for understanding how configs are structured and how servers connect.
...
<Note>
[Configuration](/v0.2.1/troubleshooting/configuration) for common configuration errors and solutions.
