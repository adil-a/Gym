...
| vLLM | [OpenAI-Compatible Server](https://docs.vllm.ai/en/v0.2.1/serving/openai_compatible_server/) |
...
- [On-Policy Corrections](/v0.2.1/contribute/rl-framework-integration/openai-compatible-http-server-on-policy-correction) - Required fixes for multi-step and multi-turn scenarios
- [Gym Integration Footprint And Form Factor](/v0.2.1/contribute/rl-framework-integration/gym-integration-footprint-and-form-factor) - Full integration component breakdown
