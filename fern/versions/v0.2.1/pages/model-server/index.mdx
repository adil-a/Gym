...
<Card title="vLLM" href="/v0.2.1/model-server/vllm">
...
<Note>
[Model Server Fields](/v0.2.1/reference/configuration#model-server-fields) for server configuration syntax and fields.
