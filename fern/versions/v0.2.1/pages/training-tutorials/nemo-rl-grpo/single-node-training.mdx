...
<NavButton href="/v0.2.1/training-tutorials/nemo-rl-grpo/setup" label="Previous: Setup" direction="prev" />
...
- ✅ Completed the [Setup](/v0.2.1/training-tutorials/nemo-rl-grpo/setup) instructions
...
<NavButton href="/v0.2.1/training-tutorials/nemo-rl-grpo/multi-node-training" label="Continue to Multi-Node Training" direction="next" />
