...
- Completed [Detailed Setup](/v0.2.1/get-started/detailed-setup)
- Collected rollouts ([Rollout Collection](/v0.2.1/get-started/rollout-collection))
...
<Card title="GRPO Training" href="/v0.2.1/training-tutorials/nemo-rl-grpo">

Train with GRPO for more powerful optimization than offline methods.
</Card>

<Card title="Build Custom Environments" href="/v0.2.1/environment-tutorials">
