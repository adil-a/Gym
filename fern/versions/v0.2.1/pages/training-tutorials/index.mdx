...
position: 1
---
We have hands-on tutorials with supported training frameworks to help you train with NeMo Gym environments. If you're interested in integrating another training framework, see the [Training Framework Integration Guide](/v0.2.1/contribute/rl-framework-integration).

<Tip>
See [training-approaches](/v0.2.1/about/concepts/training-approaches) for a refresher on when to use GRPO, SFT, or DPO.
...
<Card title="NeMo RL" href="/v0.2.1/training-tutorials/nemo-rl-grpo">
...
<Card title="Offline Training with Rollouts" href="/v0.2.1/training-tutorials/offline-training-w-rollouts">
