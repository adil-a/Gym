...
<Card title="Responses API Evolution" href="/v0.2.1/infrastructure/engineering-notes/responses-api-evolution">
...
<Card title="SWE RL Infrastructure Case Study" href="/v0.2.1/infrastructure/engineering-notes/swe-rl-case-study">
...
<Card title="aiohttp vs httpx" href="/v0.2.1/infrastructure/engineering-notes/aiohttp-vs-httpx">
