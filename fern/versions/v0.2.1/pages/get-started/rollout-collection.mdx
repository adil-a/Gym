...
<NavButton href="/v0.2.1/get-started/detailed-setup" label="Previous: Detailed Setup Guide" direction="prev" />
...
- ✅ Completed [Detailed Setup Guide](/v0.2.1/get-started/detailed-setup)
...
If you still have servers running from the [Detailed Setup Guide](/v0.2.1/get-started/detailed-setup) tutorial, proceed to the next step.
...
<Card title="Start Training" href="/v0.2.1/training-tutorials">
...
<Card title="Build a Custom Environment" href="/v0.2.1/environment-tutorials">
