...
position: 6
---
Apply YAML-based prompt templates at rollout time to build `responses_create_params.input` on the fly. Use this for prompt sweeps without re-preparing the JSONL.
...
See [Cli Commands](/api/cli) for the full list of `ng_collect_rollouts` parameters.
