...
<Card title="Single-Step Environment" href="/latest/build-environments/supported-patterns/single-step">
...
<Card title="Multi-Step Environment" href="/latest/build-environments/supported-patterns/multi-step">
Multiple sequential tool calls with ground-truth verification.

<Badge intent="success" minimal outlined>intermediate</Badge>
</Card>

<Card title="Stateful Environment" href="/latest/build-environments/supported-patterns/stateful">
...
<Card title="LLM-as-Judge Verification" href="/latest/build-environments/verification/llm-as-judge">
