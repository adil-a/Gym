...
# Side-channel key used to pass the resolved skills path from an agent's /run handler to its
# /v1/responses handler via responses_create_params.metadata (which forbids extra fields).
SKILLS_PATH_METADATA_KEY = "_ng_skills_path"
